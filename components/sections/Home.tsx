...
export default function Home({ setSelectedPage }: Props) {
  ...
  return (
    <section id="home" className='w-full h-full p-10 z-40 justify-center text-center md:text-left'>
      {/* IMAGE & HEADER */}
      <motion.div
      ...
      >
        ...
        <div className='w-full p-2 mb-8'>
          ...
          >
            ...
            {/* MAIN HEADING */}
            <div className={`flex bold text-4xl md:text-4xl lg:text-5xl p-2 bg-clip-text bg-repeat-x text-transparent bg-gradient-to-r 
                ${theme !== "light" ? (
          ...
          >
            ...
            >
              <Button variant='outline' className='bg-amber-300 hover:bg-slate-200 text-zinc-800 font-bold shadow-md' >LETS CONNECT</Button>
            </AnchorLink>
